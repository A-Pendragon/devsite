...
@section('content')
	<div class="container-fluid default-padding">
		<div class="row">	
			...
			<div class="col-xs-8">
				<form action="{{ route('updatepassword') }}" method="post" name="form" class="form-horizontal" autocomplete="off">
					<div class="edit-container panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="col-xs-12 text-right">
								...
								<button type="submit" name="cancel_btn" class="btn _btn-default-2">Cancel</button>
							</div>	
						</div>
					</div>
				</form>
