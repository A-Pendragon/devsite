...
@section('content')
	<div class="container-fluid default-padding">
		<div class="row">
			...
			<div class="col-xs-8">				
				<form action="{{ route('updatebasicinfo') }}" method="post" name="form" class="form-horizontal" autocomplete="off">
					<div class="edit-container panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="col-xs-12 text-right">
								...
								<button type="button" name="cancel_btn" class="btn _btn-default-2"><i class="glyphicon glyphicon-ban-circle"></i>&nbsp;&nbsp;Cancel</button>
							</div>
						</div>
					</div>
				</form>
