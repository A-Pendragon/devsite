...
@section('content')
	<div class="container-fluid default-padding">
		<div class="row">	
			...
			<div class="col-xs-8">
				<form action="/changeprofilepic" method="post" name="form" class="form-horizontal" autocomplete="off" enctype="multipart/form-data">
					<div class="edit-container panel panel-default">
						<div class="_panel-heading text-left">Change Profile Pic</div>
						<div class="panel-body">
							<div class="form-group">
								<div class="col-xs-12">
									<img src="/uploads/profile_pics/{{ $user->profile_pic }}" class="thumbnail change-profile-pic img-responsive">
								</div>
							...
							<div class="col-xs-12 text-right">
								...
								<button type="submit" name="cancel_btn" class="btn _btn-default-2"><i class="glyphicon glyphicon-ban-circle"></i>&nbsp;&nbsp;Cancel</button>
							</div>
						</div>
					</div>
				</form>
